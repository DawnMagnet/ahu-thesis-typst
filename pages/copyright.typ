...
#let make-copyright-page(degree: "doctor") = {
...

  {
    ...
    [本人声明所呈交的学位论文是本人在导师指导下进行的研究工作及取得的研究成果。据我所知，除了文中特别加以标注和致谢的地方外，论文中不包含其他人已经发表或撰写过的研究成果，也不包含为获得安徽大学或其他教育机构的学位或证书而使用过的材料。本人切实履行人工智能使用主体第一责任人职责，对学位论文的所有内容负最终责任。学位论文中使用人工智能生成、合成的内容（如文本、图片、音频、视频、虚拟场景等），已根据实际情况添加显式标识或隐式标识。如有学术不端行为，一切后果由本人承担，与导师和安徽大学无关。]
